...
function Cart() {
  ...
  if (!user) {
    return <div className='p-4 text-slate-600'>Please log in to view your cart.</div>
  }
        ...
        {cartItems.length === 0 ? (
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className='flex flex-1 flex-col p-3'>
                  ...
                  <p className='mt-1 text-xs text-gray-600'>${Number(item.price).toFixed(2)}</p>
          ...
          <div className='mt-8 flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <button
              ...
              className='inline-flex items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-600'
            >
              Buy Product
            </button>
          </div>
